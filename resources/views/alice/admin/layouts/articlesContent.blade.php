@if($articles)
        ...
        <table class="table table-hover">
            ...
            @foreach($articles as $article)
                <tr>
                    ...
                    <td class="align-left">{!! link_to_route('informations.edit', $article->title, ['information' => $article->alias]) !!}</td>
                    <td class="align-left">
                    ...
                    <td>{{$article->alias}}</td>
                    <td>
                        {!! Form::open(['url' => route('informations.destroy', ['information' => $article->alias]), 'class'=>'form-horizontal','method'=>'POST']) !!}
                        @method('DELETE')
                        @csrf
    ...
    {!! link_to_route('informations.create', 'Добавить информацию', null,['class' => 'btn btn-primary']) !!}
@endif