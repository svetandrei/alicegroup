@if($categories)
        ...
        <table class="table table-hover">
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <td class="align-left">{!! link_to_route('category.edit', $category->title, ['category' => $category->alias]) !!}</td>
                    <td class="align-left">
                    ...
                    <td>{{(isset($category->parent['title']))?$category->parent['title']:'Информации'}}</td>
                    <td>
                    ...
                    <td>
                        {!! Form::open(['url' => route('category.destroy', ['category' => $category->alias]), 'class'=>'form-horizontal','method'=>'POST']) !!}
                        @method('DELETE')
                        @csrf
    ...
    {!! link_to_route('category.create', 'Добавить категорию', null,['class' => 'btn btn-primary']) !!}
